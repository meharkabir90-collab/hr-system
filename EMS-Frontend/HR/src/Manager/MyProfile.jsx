...
function EmployeeDetails() {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        ...
        console.log("MANAGER PROFILE:", data.employee);
        console.log("MANAGER ROLE:", data.employee?.user?.role);
  ...
  const role = employee.user?.role
    ? employee.user.role.charAt(0).toUpperCase() +
      employee.user.role.slice(1)
    : "Manager";
      ...
      <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-lg border border-sky-100 overflow-hidden">
        ...
        <div className="p-6 md:p-8">
          ...
          <Section
            ...
            description="Your manager portal account"
          >
